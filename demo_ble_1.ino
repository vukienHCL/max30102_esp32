...
//  float temperatureF = particleSensor.readTemperatureF(); //Because I am a bad global citizen
  ...
  dtostrf(temperature, 6, 1, temperature_celsius);
  TemperatureCelsiusCharacteristics.setValue(temperature_celsius);
...
void setup() {
  ...
  // Temperature
//  #ifdef temperatureCelsius
  max30102Service->addCharacteristic(&TemperatureCelsiusCharacteristics);
  TemperatureCelsiusDescriptor.setValue("temperature");
  TemperatureCelsiusCharacteristics.addDescriptor(new BLE2902());
// #else
//  max30102Service->addCharacteristic(&TemperatureFahrenheitCharacteristics);
//  TemperatureFahrenheitDescriptor.setValue("temperature");
//  TemperatureFahrenheitCharacteristics.addDescriptor(new BLE2902());
//  #endif
...
//  dtostrf(temperatureF, 6, 2, temperature_Fahrenheit);
//  TemperatureFahrenheitCharacteristics.setValue(temperature_Fahrenheit);
